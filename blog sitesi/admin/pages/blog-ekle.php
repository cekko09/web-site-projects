...
<?php
        ...
        if(@$_POST["submit"]) {
            ...
            $aktif = htmlspecialchars(@$_POST["aktif"] , ENT_QUOTES, 'UTF-8');
                ...
                $ekle->bindValue(":alt_baslik",$alt_baslik);
                $ekle->bindValue(":aciklama",$aciklama);
                $ekle->bindValue(":aktif",$aktif);
                if($ekle->execute()) {
                    header("Location:blog.php?blog=ok");

                }else {
                    header("Location:blog-ekle.php?blog=no");
                                ...
                                <div class="col-lg-6">
                                    <form enctype="multipart/form-data" role="form" action="" method="POST"  >
                                        ...
                                        <div class="form-group">
                                            <label>Başlık</label>
                                            <input class="form-control" name="baslik" placeholder="baslık giriniz">
                                        </div>
                                        <div class="form-group">
                                            <label>Alt Başlık</label>
                                            <input class="form-control" name="alt_baslik" placeholder="alt baslık giriniz">
                                        </div>


                                        <div class="form-group">
                                            <label>Açıklama</label>
                                            <textarea id="mytextarea" name="aciklama" class="form-control" placeholder="Açıklama giriniz" rows="3"></textarea>
                                        </div>
                                        ...
                                        <input type="submit" value="kaydet" name="submit" class="btn btn-default">
