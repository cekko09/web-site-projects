...
$id= intval(@$_GET["id"]);
   if(@$_GET["islem"]=="sil") {
    ...
    header("Location:gelen-kutusu.php");
                    ...
                    header("Location:gelen-kutusu.php?ekle=hata");
                }
}
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr class="odd gradeX">
                                            ...
                                            if($row["okundu"]==1){ ?>
                                                ...
                                                <a  class="btn btn-success">okundu</a>

                                        <?php    }else {   ?>
                                                 <a  class="btn btn-danger">okunmadı</a>
                                          <?php  }
                                            
                                            ?>
                                        </td>
                                            <td class="center">
                                            <a href="mesaj-detay.php?islem=duzenle&id=<?php echo $row['id']?>" class="btn btn-warning">oku</a>
